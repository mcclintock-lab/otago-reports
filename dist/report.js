...
EnvironmentTab = (function(_super) {
  ...
  EnvironmentTab.prototype.render = function() {
    var adjacent_land, attributes, coastal_land, context, d3IsPresent, hab_sizes, habitats_represented, habs_in_sketch, habs_plural, hasCoastal, hasPublic, isCollection, isGeneric, isMPA, public_land, scid, showAdjacent;
    if (window.d3) {
      d3IsPresent = true;
    } else {
      d3IsPresent = false;
