...
UsesTab = (function(_super) {
  ...
  UsesTab.prototype.render = function() {
    var attributes, coastal_consents, context, d3IsPresent, hasCoastal, hasHeritage, hasInfrastructure, hasMammals, hasRecUses, hasSeabirds, hasSmaro, hasSpecies, hasUses, heritage, inHighDiversityReefFishArea, infrastructure, isCollection, mammals, non_smaro_rec_uses, rec, rec_uses, reef_fish, seabirds, smaro, _i, _len;
    if (window.d3) {
      d3IsPresent = true;
    } else {
      d3IsPresent = false;
