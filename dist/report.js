...
OverviewTab = (function(_super) {
  ...
  OverviewTab.prototype.render = function() {
    var attributes, coastline_length, context, d3IsPresent, isCollection, new_habs, new_size, numSketches, percent, ratio, size, total_habs;
    isCollection = this.model.isCollection();
    if (isCollection) {
      numSketches = this.model.collection.length;
    } else {
      numSketches = 1;
    }
