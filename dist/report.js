...
EnvironmentTab = (function(_super) {
  ...
  EnvironmentTab.prototype.dependencies = ['HabitatsOverview', 'AdjacentTerrestrial', 'HabRepsToolbox', 'NewHabRepsToolbox'];

  EnvironmentTab.prototype.render = function() {
    var REP_NAME, all_habs, attributes, coastal_hab_types, context, d3IsPresent, estuarine_hab_types, hab_sizes, habitats_represented, habs_in_sketch, habs_plural, hasCoastalHabTypes, hasCovenants, hasEstuarineHabTypes, hasNapalisCovenants, hasProtected, hasQE2covenants, hasSigHabs, isCollection, isConfid, isGeneric, isMPA, napalis_covenants, protected_areas, qe2_covenants, scid, showAdjacent, sig_habs;
    if (window.d3) {
      d3IsPresent = true;
    } else {
      d3IsPresent = false;
